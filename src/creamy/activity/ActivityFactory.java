...
/**
 * ActivityのFactoryクラス。Singletonクラス
 * Activityインスタンスを生成する
 *
 * @author Taiji Miyabe
 */
public class ActivityFactory {
    ...
    /**
     * アクティビティを生成する
     * @param activityClass 生成するアクティビティの型(クラス)
     * @param controller 呼出し元のユーザコントローラのインスタンス
     * @param validResult バリデーションの結果オブジェクト
     * @return 生成したアクティビティ
     */
    ...
    /**
     * アクティビティを生成する。Acitivity#renderChildrenから呼出される
     * @param activityClass 生成するアクティビティクラス
